...
This Terms of Service Agreement (the "Agreement") is entered into between Joel Marriott ("Bot Owner") and the user ("User") of the **Nobility** Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of the United Kingdom. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of the DUA Act.
